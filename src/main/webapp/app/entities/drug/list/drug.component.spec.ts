...
describe('Drug Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'drug', component: DrugComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.drugs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to drugService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDrugIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDrugIdentifier).toHaveBeenCalledWith(entity);
