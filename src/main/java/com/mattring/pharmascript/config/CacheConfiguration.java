package com.mattring.pharmascript.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.mattring.pharmascript.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.mattring.pharmascript.repository.UserRepository.USERS_BY_EMAIL_CACHE);
